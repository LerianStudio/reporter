...
// Source: k8s-golang-addons-boilerplate/pkg/db (interfaces: DBConn)
//
// Generated by this command:
//
//	mockgen --destination=../../mocks/db/connection_mock.go --package=mock . DBConn
//
...
func (mr *MockDBConnMockRecorder) Exec(query any, args ...any) *gomock.Call {
...
func (mr *MockDBConnMockRecorder) Query(query any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{query}, args...)
...
func (mr *MockDBConnMockRecorder) QueryRow(query any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{query}, args...)
