...
// Source: k8s-golang-addons-boilerplate/internal/postgres/example (interfaces: Repository)
...
import (
	context "context"
	model "k8s-golang-addons-boilerplate/pkg/example_model/model"
	http "k8s-golang-addons-boilerplate/pkg/net/http"
	reflect "reflect"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *model.Example) (*model.ExampleOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
	ret0, _ := ret[0].(*model.ExampleOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) Find(arg0 context.Context, arg1 uuid.UUID) (*model.ExampleOutput, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindAll(arg0 context.Context, arg1 http.Pagination) ([]*model.ExampleOutput, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 uuid.UUID, arg2 *model.Example) (*model.ExampleOutput, error) {
	m.ctrl.T.Helper()
