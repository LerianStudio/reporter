...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'bg-background ring-offset-background placeholder:text-shadcn-400 focus:ring-ring flex h-9 w-full items-center justify-between gap-3 rounded-md border border-[#C7C7C7] px-3 py-2 text-sm focus:ring-2 focus:ring-offset-0 focus:outline-hidden focus-visible:outline-hidden [&>span]:line-clamp-1',
      props.readOnly && [
