...
function EntityBoxRoot({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
...
function EntityBoxCollapsible({
  ...
  return (
    <Collapsible
      data-slot="entity-box-collapsible"
      className={cn(
...
function EntityBoxCollapsibleContent({
  ...
  return (
    <CollapsibleContent data-slot="entity-box-collapsible-content" {...props}>
...
function EntityBoxBanner({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
