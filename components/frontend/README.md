...
3. Open http://localhost:7081 in your browser to verify that NextJS Boilerplate is running.

## Deploying with Docker

To deploy NextJS Boilerplate in a Docker environment, execute the following npm script:
...
- For bug reports and feature requests, please use our [GitHub Issues](https://github.com/LerianStudio/midaz-console/issues) (<- Adjust this link).
- To share ideas or discuss topics with the community, start a Discussion on our [GitHub](https://github.com/LerianStudio/midaz-console/discussions) (<- Adjust this link).
